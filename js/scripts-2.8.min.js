...
window.isSearchBot = !1,
    function (e) {
        ...
        if (e(document).ready(function () {
                t.ready = Date.now() - window.performance.timing.navigationStart;
                var o = window.navigator.userAgent,
                    i = o.indexOf("Instagram"),
                    r = o.indexOf("FBAV"),
                    n = o.indexOf("YaSearchBrowser");
                if (-1 !== o.indexOf("Android") && (-1 !== r || -1 !== i || -1 !== n)) {
                ...
                t.load = Date.now() - window.performance.timing.navigationStart, t.connect = window.performance.timing.connectEnd - window.performance.timing.connectStart, t.ttfb = window.performance.timing.responseStart - window.performance.timing.connectEnd, t.basePage = window.performance.timing.responseEnd - window.performance.timing.navigationStart, t.DOMcontentLoaded = window.performance.timing.domContentLoadedEventEnd - window.performance.timing.navigationStart, t.fullLoad = window.performance.timing.domComplete - window.performance.timing.navigationStart, t.lazy = "y" === window.lazy, t.zero = e(".tn-elem").length > 0, window.winWidth && window.winWidth > 0 && (t.width = window.winWidth);
                var o = ($isMobile ? "site_m" : "site_d") + "=" + JSON.stringify(t);
                //e.post("https://turniki.promicom.ru/?" + o)
            ...
            var o = function () {
                for (var t = document.body.querySelectorAll(".t-cover__carrier"), o = e(window).height(), i = 0, r = 0, n = t.length; r < n; r++)(c = (a = t[r]).style).height.indexOf("vh") > -1 && (i = parseInt(c.height) / 100, s = Math.round(o * i) + "px", (d = e(a).parent(".t-cover")) && (d = d[0]) && (l = d.querySelector(".t-cover__filter"), p = d.querySelector(".t-cover__wrapper"), l && (l.style.height = s), p && (p.style.height = s), c.height = d.style.height = s));
                var a, c, s, d, l, p, u = document.body.querySelectorAll("[data-height-correct-vh]");
                for (o = e(window).height(), i = 0, r = 0, n = u.length; r < n; r++)(c = (a = u[r]).style).height.indexOf("vh") > -1 && (i = parseInt(c.height) / 100, s = o + "px", d = e(a).parent(".t-cover"), c.height = s)
            };
        ...
        1 == $isMobile && (e(window).width() < 480 ? (e(document).ready(function () {
            ...
            e(".r:visible").each(function () {
                var o = e(this);
                e(this).find("div").not("[data-auto-correct-mobile-width=false], .tn-elem, .tn-atom, .tn-atom__sbs-anim-wrapper, .tn-atom__prx-wrapper, .tn-atom__videoiframe, .tn-atom .t-form *").each(function () {
    ...
    function (e) {
        ...
        function o(t) {
            ...
            if ((o = i.find("div[data-hook-content]").outerHeight()) > 300 && r < o + 40 && ((o = o + 120) > 1e3 && (o += 100), console.log("auto correct cover height: " + o), i.find(".t-cover").height(o), i.find(".t-cover__filter").height(o), i.find(".t-cover__carrier").height(o), i.find(".t-cover__wrapper").height(o), 0 == $isMobile && setTimeout(function () {
                    var e = i.find(".t-cover__carrier");
                    e.find("iframe").length > 0 && (console.log("correct video from cover_fixcontentheight"), n(e, o + "px")), e.find("video").length > 0 && console.log("correct html5video from cover_fixcontentheight")
        ...
        t.prototype.defaultConfig = {
            ...
            e(document).ready(function () {
                var i = document.body.querySelector("#coverCarry" + t),
                    ...
                    c = r.attr("data-content-cover-parallax"),
                    s = r.attr("data-content-video-url-mp4"),
                ...
                n || (n = ""), a || (a = ""), c || (c = ""), s || (s = ""), d || (d = ""), l || (l = ""), p || (p = ""), u || (u = ""), l || (l = ""), h || (h = ""), f && "yes" == f && (s = "", d = "", l = ""), !$isMobile || "" == d && "" == s && "" == l || r.css("background-image", "url('" + n + "')"), setTimeout(function () {
                    o(t)
                }, 500);
                        ...
                        if ("" != l) {
                            ...
                            (x = e(window)).scroll(function () {
                                g && window.clearTimeout(g), g = window.setTimeout(function () {
                                    var e, t, o;
                                    (b = r.find("iframe").length) > 0 || (e = r.offset().top, t = r.height(), (o = x.scrollTop()) + x.height() > e - 500 && o <= e + t + 500 && processYoutubeVideo(i, a))
                                }, 100)
                            }), x.scroll()
                        }
                    } else {
                        if (r.css("background-color", "#000000"), r.css("background-image", "url('https://tilda.ws/img/spinner-white.gif')"), r.css("background-size", "auto"), r.attr("data-content-cover-bg", ""), "" != p) var v = !1;
                        else v = !0;
                        if ("" != u) var w = 1;
                        else w = "";
                        var g, y = "";
                        "fixed" == c && (a.indexOf("vh") > -1 && parseInt(a) > 100 && (r.css("height", "100vh"), y = "yes"), a.indexOf("px") > -1 && parseInt(a) > e(window).height() && (r.css("height", "100vh"), y = "yes"));
                        var b = "",
                            x = e(window),
                            _ = r.parent();
                        x.scroll(function () {
                            ...
                            (g && window.clearTimeout(g), g = window.setTimeout(function () {
                                var e, t, o;
                                if (!(b > 0) && (e = r.offset().top, t = r.height(), (o = x.scrollTop()) + x.height() > e - 500 && o <= e + t + 500)) {
                                    var i = r.videoBG({
                                        mp4: s,
                                        webm: d,
                                        poster: "",
                            ...
                            }, 100), "fixed" == c && "yes" == y) && (e = _.offset().top, t = _.height(), (o = x.scrollTop()) >= e + t - x.height() ? (r.css("position", "absolute"), r.css("bottom", "0px"), r.css("top", "auto")) : o >= e ? (r.css("position", "fixed"), r.css("top", "0px")) : o < e && (r.css("position", "relative"), r.css("top", "auto")))
                        }), x.scroll()
                    } if ("dynamic" == c && 0 == $isMobile && r.parallax("50%", .2, !0), "yes" == h && "" != n && "" == s && "" == d && "" == l) {
                    e("<img/>").attr("src", n).load(function () {
                        e(this).remove(), r.css("background-image", "url('" + n + "')"), r.css("opacity", "1")
                    }), r.css("background-image", ""), r.css("opacity", "0"), r.css("transition", "opacity 25ms")
                }
                var T = e("#rec" + t).find(".t-cover__arrow-wrapper");
        ...
        function n(t, o) {
            ...
            if (a > 0 && (c = 1 * parseFloat(a)), "yes" != r) {
                ...
                var p = l,
                    ...
                    h = y,
                    f = 1;
                if ("yes" == n || (u = u + 110 + 110, h = y - 220), h < d)
                    if (y < d) f = d / y + .02;
                    else f = y / d + .02;
                var m = Math.floor(p * f),
                    ...
                    w = v - d,
                    g = m - l;
                i.height(v + "px"), i.width(m + "px"), w > 0 && i.css("margin-top", -Math.floor(w / 2) + "px"), g > 0 && i.css("margin-left", -Math.floor(g / 2) + "px")
            } else {
                var y;
        ...
        window.processYoutubeVideo = function (t, o) {
            ...
            r.then(function () {
                ...
                }(c, l, s), p.frameBorder = 0, p.allow = "autoplay", t.appendChild(p), 0 == $isMobile && new YT.Player(p, {
                    events: {
                        onReady: function (o) {
                            ! function (t, o, r) {
                                var n, a = e(window),
                                    ...
                                    s = 0;
                                a.scroll(function () {
                                    n && (window.clearTimeout(n), s >= 15 && (i(c, a, o, r), s = 0), s++), n = window.setTimeout(function () {
                                        i(c, a, o, r), s = 0
                                    }, 100)
                                }), a.scroll()
                        ...
                        onStateChange: function (t) {
                            ...
                            t.data === YT.PlayerState.PLAYING ? r = window.setInterval(function () {
    ...
    function (e) {
        ...
        function o() {
            ...
            e("div.r[data-screen-max], div.r[data-screen-min]").each(function (n) {
                i = e(this).css("display"), void 0 === (t = e(this).attr("data-screen-max")) && (t = 1e4), t = parseInt(t), void 0 === (o = e(this).attr("data-screen-min")) && (o = 0), (o = parseInt(o)) <= t && (r <= t && r > o ? "block" != i && e(this).css("display", "block") : "none" != i && e(this).css("display", "none"))
            })
        }
        e(document).ready(function () {
    ...
    function (e) {
        e.fn.videoBG = function (t, o) {
            ...
            if (i.length) {
                ...
                return o.scale && r.height(o.height).width(o.width), i.append(r), void 0 === i.attr("data-content-video-nomute") && i.find("video").prop("muted", !0),
                    function (t, o) {
                        ...
                        if (c > 0 && (s = 1 * parseFloat(c)), "yes" != a) {
                            ...
                            var m = Math.floor(u * f),
                                ...
                                w = v - l,
                                g = m - p;
                            n.height(v + "px"), n.width(m + "px"), w > 0 && n.css("margin-top", -Math.floor(w / 2) + "px"), g > 0 && n.css("margin-left", -Math.floor(g / 2) + "px")
                        } else {
                            var y;
            ...
            var i, r = e("<video/>");
            (r.css("position", "relative").css("z-index", t.zIndex).attr("poster", t.poster).css("top", 0).css("left", 0).css("min-width", "100%").css("min-height", "100%"), t.autoplay && r.attr("autoplay", t.autoplay), t.volume > 0 ? r.prop("volume", t.volume) : r.prop("volume", 0), t.fullscreen) && (r.bind("canplay", function () {
    ...
    function (e) {
        ...
        t.resize(function () {
            ...
            }, window.correctFirstTop4Parallax(), a = n ? function (e) {
                return e.outerHeight(!0)
            } : function (e) {
                return e.height()
            }, (arguments.length < 1 || null === i) && (i = "50%"), (arguments.length < 2 || null === r) && (r = .1), (arguments.length < 3 || null === n) && (n = !0), e(window).resize(window.correctFirstTop4Parallax), t.bind("scroll", d).resize(d), "complete" !== document.readyState ? window.addEventListener("load", function () {
                d()
            }) : d()
        }
    ...
    function (e) {
        Tilda.sendEcommerceEvent = function (t, o) {
            ...
            for (i = 0; i < o.length; i++) {
                ...
                a.uid && a.uid > 0 && (p = a.uid, h.uid = a.uid), a.recid && a.recid > 0 && (l = a.recid, h.recid = a.recid), a.lid && a.lid > 0 && (u = a.lid, h.lid = a.lid), a.sku && a.sku > 0 && (h.sku = a.sku), d[d.length] = h
            }
            "add" != t && "remove" != t || (r = "/tilda/cart/" + remove + "/", l > 0 && (r += "" + l), p > 0 ? r += "-u" + p : u > 0 && (r += "-" + u)), "detail" == t && (r = "/tilda/product/detail/", p > 0 ? r += p + "/" : (l > 0 && (r += "r" + l), u > 0 && (r += "-l" + u))), "purchase" == t && (r = "/tilda/rec" + l + "/payment/"), (h = {
                ecommerce: {}
            }).ecommerce[t] = {
                products: d
                    ...
                    if (i && i.event) {
                        try {
                            if (window.Tilda.isLoadGAEcommerce || (window.Tilda.isLoadGAEcommerce = !0, ga("require", "ec")), ga("set", "currencyCode", l), "purchase" == i.event) {
                                ...
                                for (w = 0; w < p; w++) v = i.ecommerce.purchase.products[w], ga("ec:addProduct", {
                                    id: v.id || w,
                                    name: v.name,
                                ...
                                for (w = 0; w < p; w++) v = i.ecommerce.add.products[w], ga("ec:addProduct", {
                                    id: v.id || w,
                                    name: v.name,
                                    price: parseFloat(v.price).toFixed(2),
                                    quantity: v.quantity
                                ...
                                for (w = 0; w < p; w++) v = i.ecommerce.remove.products[w], ga("ec:addProduct", {
                                    id: v.id || w,
                                    name: v.name,
                                    price: parseFloat(v.price).toFixed(2),
                                    quantity: v.quantity
                                ...
                                for (w = 0; w < p; w++) v = i.ecommerce.detail.products[w], ga("ec:addProduct", {
                                    id: v.id || w,
                                    name: v.name,
                                    price: parseFloat(v.price).toFixed(2),
                                    quantity: v.quantity
            ...
            if (window.mainMetrika > "" && window[window.mainMetrika] && (n ? r > 0 ? window[window.mainMetrika].hit(t, {
                ...
                if (n)
                    if (-1 == t.indexOf("tilda/") || -1 == t.indexOf("/payment/") && -1 == t.indexOf("/submitted/"))
                        if (i && i.event && r > 0)
                            if ("addToCart" == i.event && i.ecommerce.add) {
                                p = i.ecommerce.add.products.length;
                                var u = [];
                                for (w = 0; w < p; w++) v = i.ecommerce.add.products[w], u.push(v.id || v.uid || v.name);
                    ...
                    p = i.ecommerce.detail.products.length, u = [];
                    for (w = 0; w < p; w++) v = i.ecommerce.detail.products[w], u.push(v.id || v.uid || v.name);
            ...
            if (void 0 !== window.VK && void 0 !== window.VK.Retargeting && 0 == d) try {
                if (n) {
                    var h = e("#allrecords").data("vk-price-list-id") ? parseInt(e("#allrecords").data("vk-price-list-id")) : 0,
                        f = "",
                        m = !1;
                    if (i && i.event)
                        if (m = {
                            ...
                            if (r > 0 && h > 0) {
                                m.currency_code = l;
                                p = i.ecommerce.purchase.products.length, u = [];
                                for (w = 0; w < p; w++) v = i.ecommerce.purchase.products[w], m.products.push({
                        ...
                        if (r > 0 && h > 0) {
                            m.currency_code = l;
                            p = i.ecommerce.add.products.length, u = [];
                            for (w = 0; w < p; w++) v = i.ecommerce.add.products[w], m.products.push({
                                id: v.id || v.uid || v.name,
                                price: v.price ? v.price : 0
                            }), m.total_price = r;
                            f = "add_to_cart"
                        } else f = "t-add-to-cart", i.ecommerce.add[0] && i.ecommerce.add[0].uid && (f += "-" + i.ecommerce.add[0].uid);
                    else if ("viewProduct" == i.event && i.ecommerce.detail)
                        if (r > 0 && h > 0) {
                            m.currency_code = l;
                            p = i.ecommerce.detail.products.length, u = [];
                            for (w = 0; w < p; w++) v = i.ecommerce.detail.products[w], m.products.push({
                                id: v.id || v.uid || v.name,
                                price: v.price ? v.price : 0
                            }), m.total_price = r;
                            f = "view_product"
                        } else f = "t-view-product", i.ecommerce.detail[0] && i.ecommerce.detail[0].uid && (f += "-" + i.ecommerce.detail[0].uid);
                    else if ("removeFromCart" == i.event && i.ecommerce.remmove)
                        if (r > 0 && h > 0) {
                            m.currency_code = l;
                            var v, w;
                            p = i.ecommerce.remove.products.length, u = [];
                            for (w = 0; w < p; w++) v = i.ecommerce.remove.products[w], m.products.push({
                                id: v.id || v.uid || v.name,
                                price: v.price ? v.price : 0
                            }), m.total_price = r;
                            f = "remove_from_cart"
                        } else f = "t-remove-product", i.ecommerce.remove[0] && i.ecommerce.remove[0].uid && (f += "-" + i.ecommerce.remove[0].uid);
                    else f = i.event;
                    else if (-1 != t.indexOf("tilda/") && -1 != t.indexOf("/payment/")) f = "t-purchase-" + t.replace("tilda/", "").replace("/payment/", "");
                    else if (-1 != t.indexOf("tilda/") && -1 != t.indexOf("/submitted/")) f = "t-lead-" + t.replace("tilda/", "").replace("/submitted/", "");
                    else if (-1 != t.indexOf("tilda/popup")) f = "t-" + t.replace("tilda/", "").replace("/", "-");
                    else if (-1 != t.indexOf("tilda/click")) f = "t-" + t.replace("tilda/", "").replace("/", "-");
                    else f = "t-" + t.replace("/", "-");
                    h > 0 && m && m.currecy_code ? (VK.Retargeting.Event("purchase"), VK.Retargeting.ProductEvent(h, f, m)) : VK.Retargeting.Event(f)
